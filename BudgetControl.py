...
#     ellist = models.Income.query.all()
#     print(ellist)
#     return render_template("index.html", title="home", list=ellist, form=forms.AddIncome(), editForm = forms.ChangeIncome(), filterform=forms.FilterForm())
#
#
# @app.route('/user/<username>')
# def show_user(username):
#     user = {'nickname': models.Income.query.first_or_404()}
